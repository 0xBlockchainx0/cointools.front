  ...
  <div class="flex flex-col">
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
      <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
        <div class="shadow overflow-hidden border sm:rounded-lg">
          <table class="min-w-full divide-y divide-border">
            <thead >
            <tr>
              <th v-for="(item, index) in head" :index="index" scope="col" class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">
                {{item}}
              </th>
            </tr>
            </thead>
